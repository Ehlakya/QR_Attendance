...
const TeacherDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">{user?.role} Dashboard</h2>
        <p className="text-textSecondary">Manage your assigned students and attendance.</p>
      </div>
      ...
      {user?.role === 'Class Teacher' && <PendingRegistrations sectionId={sectionId} />}
